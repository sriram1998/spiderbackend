...
<p>Hello Professor <?php print "$user"?></p>
<a href="logout.php" id="lo">Click here to logout</a><br></br>
<a href="change.php" id="ch">Make admin</a><br></br>
<form action="add.php" method="POST">
<textarea placeholder="ENTER NOTICE TO BE ADDED:" rows="4" columns="50" id=textin name="details"></textarea><br></br>
...
while($row=mysql_fetch_array($query))
{
	...
	Print '<td align="center"><a href="edit.php?id='. $row['id'] .'">DELETE</a> </td>';
	Print "</tr>";
